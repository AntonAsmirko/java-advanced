...
public class Implementor implements Impler, JarImpler {
    ...
    /**
     * Generates {@link Path} to target file used or generated by compiler in {@link Implementor#implementJar(Class, Path)}.
     *
    ...
    /**
     * Returns all <code>abstract</code> <code>public</code>, <code>protected</code> and <code>package-private</code> methods
     ...
     * @param name       {@link String} representing name of {@link Executable}.
     * @param format     {@link String} representing formatting pattern.
     * @param arguments  {@link String} representing the arguments of executable.
     * @param modifiers  {@link String} representing everything that should be written before executables name.
     ...
     * @return string of parameters joined in pattern <code>"type name"</code>.
     ...
     *
     * @param constructors {@link Constructor constructors} to implement code.
     * @return {@link String} containing a code of implemented constructors.
     */
     ...
     *
     * @param token {@link Class} to implement methods code.
     * @return {@link String} of implemented methods.
     */
